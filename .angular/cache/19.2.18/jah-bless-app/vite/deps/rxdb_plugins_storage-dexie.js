...
function dexieQuery(instance, preparedQuery) {
  return __async(this, null, function* () {
    ...
    var rows = [];
    yield state.dexieDb.transaction("r", state.dexieTable, (dexieTx) => __async(null, null, function* () {
