    ...
    (function(e) {
      ...
      return (/* @__PURE__ */ function() {
          ...
          (function() {
            (function() {
              ...
              n2.kMaxLength = 2147483647, s.TYPED_ARRAY_SUPPORT = function() {
                ...
                enumerable: false,
                writable: false
              }), s.poolSize = 8192, s.from = function(e2, t4, n3) {
                return l(e2, t4, n3);
        ...
        5: [function(e, t2) {
          t2.exports = function(t3) {
            function r2(e2) {
              ...
              let n2, o2 = null;
              return t4.namespace = e2, t4.useColors = r2.useColors(), t4.color = r2.selectColor(e2), t4.extend = a, t4.destroy = r2.destroy, Object.defineProperty(t4, "enabled", {
                enumerable: true,
                configurable: false,
                get: () => null === o2 ? r2.enabled(e2) : o2,
                set: (e3) => {
                  o2 = e3;
                }
        ...
        6: [function(e, t2) {
          "use strict";
          function n2(e2, t3) {
            for (const n3 in t3) Object.defineProperty(e2, n3, {
              value: t3[n3],
              enumerable: true,
              configurable: true
            });
        ...
        7: [function(e, t2) {
          ...
          var C = 10;
          Object.defineProperty(r2, "defaultMaxListeners", {
            enumerable: true,
            get: function() {
              return C;
            },
        ...
        16: [function(e, t2) {
          (function(n2) {
            (function() {
              ...
              Object.defineProperty(r2.prototype, "writableHighWaterMark", {
                enumerable: false,
                get: function() {
                  return this._writableState.highWaterMark;
                }
              }), Object.defineProperty(r2.prototype, "writableBuffer", {
                enumerable: false,
                get: function() {
                  return this._writableState && this._writableState.getBuffer();
                }
              }), Object.defineProperty(r2.prototype, "writableLength", {
                enumerable: false,
                get: function() {
                  return this._writableState.length;
                }
              }), Object.defineProperty(r2.prototype, "destroyed", {
                enumerable: false,
                get: function() {
            ...
            (function() {
              ...
              s.prototype.read = function(e2) {
                ...
                if (!e2) {
                  ...
                  for (var o2 = 0; o2 < a2; o2++) r3[o2].emit("unpipe", this, {
                    hasUnpiped: false
                  });
                  return this;
                }
        ...
        19: [function(e, t2) {
          ...
          function r2(e2) {
            return this instanceof r2 ? void (u.call(this, e2), this._transformState = {
              afterTransform: n2.bind(this),
              needTransform: false,
              transforming: false,
              writecb: null,
              writechunk: null,
              writeencoding: null
            }, this._readableState.needReadable = true, this._readableState.sync = false, e2 && ("function" == typeof e2.transform && (this._transform = e2.transform), "function" == typeof e2.flush && (this._flush = e2.flush)), this.on("prefinish", a)) : new r2(e2);
          }
          function a() {
            var e2 = this;
        ...
        20: [function(e, t2) {
          (function(n2, r2) {
            (function() {
              ...
              function f(e2, t3, n3, r3, a2, o2) {
                ...
                if (s2 || (t3.needDrain = true), t3.writing || t3.corked) {
                  ...
                  t3.lastBufferedRequest = {
                    ...
                    callback: o2,
                    next: null
                  }, l2 ? l2.next = t3.lastBufferedRequest : t3.bufferedRequest = t3.lastBufferedRequest, t3.bufferedRequestCount += 1;
              ...
              }, A = e("./internal/streams/stream"), x = e("buffer").Buffer, N = r2.Uint8Array || function() {
          ...
          (function(n2) {
            (function() {
              ...
              t2.exports = function(e2) {
                var t3, n3 = Object.create(b, (t3 = {}, r2(t3, h, {
                  value: e2,
                  writable: true
                }), r2(t3, c, {
                  value: null,
        ...
        26: [function(e, t2) {
          ...
          function o(t3, r3, o2, i2) {
            ...
            t3.on("close", function() {
              d2 = true;
            }), l === void 0 && (l = e("./end-of-stream")), l(t3, {
              readable: r3,
              writable: o2
            }, function(e2) {
        ...
        27: [function(e, n2) {
          ...
          n2.exports = {
            getHighWaterMark: function(e2, n3, o, i) {
              var d = r2(n3, i, o);
              if (null != d) {
        ...
        "/": [function(e, t2) {
          ...
          const a = e("debug")("simple-peer"), o = e("get-browser-rtc"), i = e("randombytes"), d = e("readable-stream"), s = e("queue-microtask"), l = e("err-code"), {
            Buffer: c
          } = e("buffer"), u = 65536;
          class p extends d.Duplex {
            ...
            _onIceCandidate(e2) {
              this.destroyed || (e2.candidate && this.trickle ? this.emit("signal", {
                type: "candidate",
                candidate: {
                  candidate: e2.candidate.candidate,
                  sdpMLineIndex: e2.candidate.sdpMLineIndex,
                  sdpMid: e2.candidate.sdpMid
                }
              }) : !e2.candidate && !this._iceComplete && (this._iceComplete = true, this.emit("_iceComplete")), e2.candidate && this._startIceCompleteTimeout());
            }
            ...
            _onTrack(e2) {
              this.destroyed || e2.streams.forEach((t3) => {
                this._debug("on track"), this.emit("track", e2.track, t3), this._remoteTracks.push({
                  track: e2.track,
                  stream: t3
                }), this._remoteStreams.some((e3) => e3.id === t3.id) || (this._remoteStreams.push(t3), s(() => {
...
var RxReplicationState = function() {
  ...
  _proto.cancel = function cancel() {
    return __async(this, null, function* () {
      this.startQueue = this.startQueue.catch(() => {
      }).then(() => __async(this, null, function* () {
        yield this._cancel();
      }));
      yield this.startQueue;
    });
  };
  _proto._cancel = function _cancel(doNotClose = false) {
    return __async(this, null, function* () {
      if (this.isStopped()) {
  ...
  _proto.remove = function remove() {
    return __async(this, null, function* () {
      this.startQueue = this.startQueue.then(() => __async(this, null, function* () {
        var metaInfo = yield this.metaInfoPromise;
        yield this._cancel(true);
        yield ensureNotFalsy(this.internalReplicationState).checkpointQueue.then(() => ensureNotFalsy(this.metaInstance).remove());
...
function isMasterInWebRTCReplication(hashFunction, ownStorageToken, otherStorageToken) {
  return __async(this, null, function* () {
    var isMaster = (yield hashFunction([ownStorageToken, otherStorageToken].join("|"))) > (yield hashFunction([otherStorageToken, ownStorageToken].join("|")));
    return isMaster;
  });
}
...
function getConnectionHandlerSimplePeer({
  ...
  var creator = (options) => __async(null, null, function* () {
    ...
    (() => __async(null, null, function* () {
      while (true) {
        yield promiseWait(SIMPLE_PEER_PING_INTERVAL / 2);
        if (closed) {
          break;
        }
        if (socket) {
    ...
    var handler = {
      ...
      send(peer, message) {
        return __async(this, null, function* () {
          yield peer.send(JSON.stringify(message));
        });
      },
      close() {
        closed = true;
...
// node_modules/rxdb/dist/esm/plugins/replication-webrtc/signaling-server.js
var PEER_ID_LENGTH = 12;
function startSignalingServerSimplePeer(serverOptions) {
  return __async(this, null, function* () {
    var {
      WebSocketServer
    } = yield import("./browser-N7BKKSXK.js");
    var wss = new WebSocketServer(serverOptions);
    var peerById = /* @__PURE__ */ new Map();
    ...
    function disconnectSocket(peerId, reason) {
      ...
      if (peer) {
        peer.socket.close && peer.socket.close(void 0, reason);
      ...
      ws.on("message", (msgEvent) => {
        ...
        switch (type) {
          case "join":
            ...
            var room = getFromMapOrCreate(peersByRoom, message.room, () => /* @__PURE__ */ new Set());
            room.add(peerId);
            room.forEach((otherPeerId) => {
              var otherPeer = peerById.get(otherPeerId);
              if (otherPeer) {
                sendMessage2(otherPeer.socket, {
                  type: "joined",
          ...
          case "signal":
            ...
            if (receiver) {
              sendMessage2(receiver.socket, message);
            }
            break;
          case "ping":
            break;
...
function sendMessage2(ws, message) {
...
function replicateWebRTC(options) {
  return __async(this, null, function* () {
    ...
    if (collection.database.multiInstance) {
      yield collection.database.waitForLeadership();
    }
    ...
    var storageToken = yield collection.database.storageToken;
    var pool = new RxWebRTCReplicationPool(collection, options, yield options.connectionHandlerCreator(options));
    ...
    var connectSub = pool.connectionHandler.connect$.pipe(filter(() => !pool.canceled)).subscribe((peer) => __async(null, null, function* () {
      if (options.isPeerValid) {
        var isValid = yield options.isPeerValid(peer);
        if (!isValid) {
          return;
        }
      }
      var peerToken;
      try {
        var tokenResponse = yield sendMessageAndAwaitAnswer(pool.connectionHandler, peer, {
          id: getRequestId(),
          method: "token",
          params: []
        });
      ...
      var isMaster = yield isMasterInWebRTCReplication(collection.database.hashFunction, storageToken, peerToken);
      ...
      if (isMaster) {
        ...
        var messageSub = pool.connectionHandler.message$.pipe(filter((data) => data.peer === peer), filter((data) => data.message.method !== "token")).subscribe((data) => __async(null, null, function* () {
          var {
            peer: msgPeer,
            message
          } = data;
          var method = masterHandler[message.method].bind(masterHandler);
          var result = yield method(...message.params);
          var response = {
            id: message.id,
            result
          };
        ...
        replicationState = replicateRxCollection({
          ...
          pull: options.pull ? Object.assign({}, options.pull, {
            handler(lastPulledCheckpoint) {
              return __async(this, null, function* () {
                var answer = yield sendMessageAndAwaitAnswer(pool.connectionHandler, peer, {
...
var RxWebRTCReplicationPool = function() {
  ...
  _proto.cancel = function cancel() {
    return __async(this, null, function* () {
      ...
      yield this.connectionHandler.close();
    });
  };
...
*/
//# sourceMappingURL=rxdb_plugins_replication-webrtc.js.map
